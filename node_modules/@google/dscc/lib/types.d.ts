...
export declare type ConfigDataElement = ConfigDataElementMaxResults | ConfigDataElementMetric | ConfigDataElementDimension;
export declare type ConfigStyleValue = string | {} | boolean | {
    color: string;
};
